...
global.sgh = 'https://github.com/sanxd'
global.sgc = 'https://chat.whatsapp.com/CVUQfRMxuF76mvZLZhUWRx'
...
/*============== WATERMARK ==============*/
global.wm = 'Fukakukラ | By SanXd' //Main Watermark
global.wm2 = 'SanBotz'
global.wm3 = 'Sanzyラ | By Raknu'
global.botdate = `⟢ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⟢ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `⟢ 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `SanXdラ | ʙʏ ${global.nameown}`
global.author = 'SanXd' 
...
global.botintro = 'Hallo, Kenalin saya SanBotz Saya akan membantu Anda kapan pun & Dimana pun, Saya asisten bot WhatsApp yang di buat oleh *SanXd* Saya di rilis pada tanggal\n🗓 ️_16/10/2022_'
